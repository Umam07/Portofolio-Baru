...
export const portfolioData = {
  personal: {
    ...
    headline: 'Fresh graduate passionate about Software Development, UI/UX Design, and Cyber Security.',
    subtext: 'Fresh graduate passionate about Software Development, UI/UX Design, and Cyber Security. Documenting my journey in tech, hands-on projects, and digital products built along the way.',
